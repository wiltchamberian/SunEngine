...
Sun::ComAccessPtr getEntityAccessPtrComponent(const Sun::EntityAccessPtr& ptr, Sun::ECSMgr* mgr) {
...
template<class _ComType>
Sun::ComAccessPtr Sun::EntityAccessPtr::getComponentPtr(Sun::ECSMgr* mgr) const {
...
template<size_t I>
Sun::ComAccessPtr getComAccessPtr(const Sun::EntityAccessPtr& ptr, Sun::ECSMgr* mgr) {

...
namespace Sun {
	...
	public:
		...
		ComAccessPtr getComponentPtr(ECSMgrBase* mgr) const;
	...
	template<class _ComType>
	ComAccessPtr getEntityAccessPtrComponent(const EntityAccessPtr& ptr, ECSMgrBase* mgr);

	template<class _ComType>
	_ComType* getEntityAccessPtrComPtr(const EntityAccessPtr& ptr, ECSMgrBase* mgr);

	template<size_t I>
	ComAccessPtr getComAccessPtr(const EntityAccessPtr& ptr, ECSMgrBase* mgr);
